...
% global maxGreen
% global maxBlue
global robot_minBlue
global robot_minRed
global robot_minGreen
...
roboSmallCircleMaxDia=35;

roboLargeCircleMinDia=35;
roboLargeCircleMaxDia=60;
...
%    sampleArena=imcrop(sampleArena,cropRect);
    ...
    elseif(full_image==2)% if search in bigger bax
        ...
        BW_OurRobot=(sampleArena(:,:,1)>=robot_minRed & sampleArena(:,:,2)>=robot_minGreen & sampleArena(:,:,3)>=robot_minBlue ); %...
%                 | redPart | greenPart;
        upper_box_point =[1,1];
...
%         &((sampleArena(upper_box_point(2):lower_box_point(2),upper_box_point(1):lower_box_point(1),3)>=minWhite(3))));
    bwRoboAllCircle =(((sampleArena(upper_box_point(1):lower_box_point(1),upper_box_point(2):lower_box_point(2),1)>=robot_minRed)) ...
        &((sampleArena(upper_box_point(1):lower_box_point(1),upper_box_point(2):lower_box_point(2),2)>=robot_minGreen)) ...
        &((sampleArena(upper_box_point(1):lower_box_point(1),upper_box_point(2):lower_box_point(2),3)>=robot_minBlue)));
%     
...
%%
    ...
    imshow(sampleArena);
    hold on;
    plot(ourRobotFrontCordi(1,2),ourRobotFrontCordi(1,1),'*blue',ourRobotBackCordi(1,2),ourRobotBackCordi(1,1),'*red');
    hold off;
%     close all;
