...
g_minWhiteColorRobot = [200 200 200];

%robot black color (MAX)
g_maxBlackColorRobot = [90 90 60];

%red Robot
g_color_min_red_Robot = [80 0 0];
g_color_max_red_Robot = [255 70 70];
g_red_over_green_Robot_red = 55;
g_red_over_blue_Robot_red = 60;

%Blue Robot
g_color_min_blue_Robot = [0 0 65]
g_color_max_blue_Robot = [95 120 255];
g_blue_over_green_Robot_blue = 40 ;
g_blue_over_red_Robot_blue = 40;

%
g_minAreaOfOppRobo = 200;

opponnentRoboBulgSize = 25;
