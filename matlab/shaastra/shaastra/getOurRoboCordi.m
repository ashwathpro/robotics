...
% % % %    sampleArena=imread('roboarenaFinal2.jpg');
   sampleArena=imcrop(sampleArena,cropRect);
    ...
    elseif(full_image==2)% if search in bigger bax
        ...
        BW_OurRobot=(sampleArena(:,:,1)>=minRed & sampleArena(:,:,2)>=minGreen & sampleArena(:,:,3)>=minBlue ); %...
%                 | redPart | greenPart;
        upper_box_point =[1,1];
...
%         &((sampleArena(upper_box_point(2):lower_box_point(2),upper_box_point(1):lower_box_point(1),3)>=minWhite(3))));
    bwRoboAllCircle =(((sampleArena(upper_box_point(1):lower_box_point(1),upper_box_point(2):lower_box_point(2),1)>=minRed)) ...
        &((sampleArena(upper_box_point(1):lower_box_point(1),upper_box_point(2):lower_box_point(2),2)>=minGreen)) ...
        &((sampleArena(upper_box_point(1):lower_box_point(1),upper_box_point(2):lower_box_point(2),3)>=minBlue)));
%     
