...
blueTarget=(targets(:,:,1)<=maxRed & targets(:,:,2)<=maxGreen & targets(:,:,3)>=minBlue ...
            & targets(:,:,3)-targets(:,:,1)>=blueOverRed & targets(:,:,3)-targets(:,:,2)>=blueOverGreen);
