...
while(1)
    ...
    if(NOurRobotW~=1)
        ...
        g_OurRobotWhiteCordi =  regionPropertiesOurRobotW(indexOurRobotW).Centroid + upper_box_point-1;
    else
        g_OurRobotWhiteCordi =  regionPropertiesOurRobotW.Centroid + upper_box_point-1;
    end
    ...
    if(NOurRobotB~=1)
        ...
        g_OurRobotBlackCordi =  regionPropertiesOurRobotB(indexOurRobotB).Centroid + upper_box_point-1;
    else
        g_OurRobotBlackCordi =  regionPropertiesOurRobotB.Centroid + upper_box_point-1;
    end
    ...
    if(back_flag==0)
        fprintf('\nROBOT_BACK_CORDINATES cant detected')
        full_image=1;
        continue;
    end
