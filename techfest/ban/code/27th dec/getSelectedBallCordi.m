function  selectedBallCordi = getSelectedBallCordi()
...
switch color_of_ball
    case 1 %yellow ball
        BW_ball=((input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),1)>=color_min_yellowball(1)) ...
            ...
            &((input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),2)>=...
            input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),3))+green_over_blue_yellowBall));
    case 2 %orange ball
        BW_ball=((input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),1)>=color_min_orangeball(1)) ...
            &(input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),2)<=color_max_orangeball(2)) ...
            &(input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),3)<=color_max_orangeball(3))...
            &(input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),1)>=...
            input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),2)+red_over_green_orangeBall) ...
            &((input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),1)>=...
            input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),3)+red_over_blue_orangeBall)) ...
            &((input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),2)>=...
            input_colored_image(upper_ball_cordi(2):lower_ball_cordi(1),upper_ball_cordi(1):lower_ball_cordi(1),3)+green_over_blue_orangeBall)));
end
