...
color_min_yellowball=[210 190 0];
color_max_yellowball=[255 255 80];
red_over_blue_yellowBall=100;
green_over_blue_yellowBall=100;
...
BW_ORANGE=((input_colored_image(:,:,1)>=color_min_orangeball(1)) ...
 ...
 BW_ORANGE=imclose(BW_ORANGE, strel('square',6));
