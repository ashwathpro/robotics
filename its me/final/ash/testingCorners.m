...
distance_from_corner =  40;    % =110 for most worst cases

g_cordiTimeoutSec       = 20;
g_TimeOutDisplacement   = 35;
%
...
if(sum(numOfBalls)~=0)
    ...
    hold on;
    plot(corner_cordinates(:,1),corner_cordinates(:,2),'rs','LineWidth',2,'Color','g');
    for j=1:numOfCorners-1
        line([corner_cordinates(j:j+1,1)],[corner_cordinates(j:j+1,2)]);
    end
