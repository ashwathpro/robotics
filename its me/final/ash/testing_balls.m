...
color_min_yellowball=[110 120 0];
color_max_yellowball=[255 255 170];
...
color_min_orangeball=[190 90 0];
color_max_orangeball=[255 170 130];
red_over_green_orangeBall=40;
red_over_blue_orangeBall=60;
green_over_blue_orangeBall =0;

BW_ORANGE=((input_colored_image(:,:,1)>=color_min_orangeball(1)) ...
      &(input_colored_image(:,:,2)<=color_max_orangeball(2)) ...
      &(input_colored_image(:,:,2)>=color_min_orangeball(2)) ...
