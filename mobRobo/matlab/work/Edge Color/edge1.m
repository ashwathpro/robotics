function varargout = edge1(varargin)
% EDGE1 Application M-file for edge1.fig
%    FIG = EDGE1 launch edge1 GUI.
%    EDGE1('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 15-Mar-2003 14:15:16
